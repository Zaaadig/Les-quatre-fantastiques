...
namespace UnityEngine.Splines
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu("Splines/Spline Instantiate Custom")]
    public class SplineInstantiateCustom : SplineComponent
    {
        /// <summary>
        ...
        void CheckChildrenValidity()
        {
            ...
            var ids = GetComponents<SplineInstantiateCustom>().Select(sInstantiate => sInstantiate.GetInstanceID()).ToList();
        ...
        bool SpawnPrefab(int index)
        {
            ...
            if (index >= m_Instances.Count)
            {
                ...
                {
                    Debug.Log("F e" + m_CurrentItem.Prefab);
